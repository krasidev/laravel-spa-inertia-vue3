<template>
    <AppLayout>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-transparent">{{ lang.menu.roles.create }}</div>
            ...
            <div class="card-body">
                <form @submit.prevent="submit">
                    ...
                    <button type="submit" class="btn btn-primary">{{ lang.content.roles.buttons.store }}</button>
                </form>
            </div>
        </div>
    </AppLayout>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit () {
                router.post(route('roles.store'), this.role);
            }
        }
    }
</script>
